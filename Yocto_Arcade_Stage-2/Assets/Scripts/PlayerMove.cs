...
public class PlayerMove : MonoBehaviour
{
    ...
    void Jump()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space) && OnGround && !lockjump) //Если нажат space и персонаж стоит на земле тогда импульс направленный вверх умноженный на силу прыжка
        {
