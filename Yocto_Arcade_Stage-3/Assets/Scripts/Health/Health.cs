...
public class Health : MonoBehaviour
{
    ...
    public PlayerRespawn resp;

    //Переменные для перезагрузки врагов
    public AIPath airestartBat;
    public Destination dotagressiveBat;
    public AIPath airestartWolf;
    public Destination dotagressiveWolf;
    ...
    public void Respawn()
    {
        ...
        anim.Play("idle");
        Invoke("DelayScreen", 1.5f);


        airestartBat.enabled = true;
        //dotagressiveBat.Checkbox = true;

        airestartWolf.enabled = true;
        //dotagressiveWolf.Checkbox = true;
    }
